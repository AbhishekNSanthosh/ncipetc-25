...
export default function SubmissionGuidelinesContent() {
  return (
    <div className="px-4 sm:px-[5vw] pt-[80px] lg:pt-[100px] pb-6 sm:pb-[5vh]">
      <div className="flex flex-col space-y-6 sm:space-y-8">
        <div className="">
          <Titlebar
            className="lg:text-2xl text-base sm:text-lg font-medium text-primary-600"
        ...
        <div className="flex flex-col space-y-4 sm:space-y-5">
          ...
          <p className="text-justify text-base sm:text-lg text-gray-700">
            ...
            rejection of papers is based on peer review of the full papers. The number of authors are also limimted to 6.
            The size of the paper is limited to 6 pages conforming to the IEEE
        ...
        <div className="flex flex-col space-y-4 sm:space-y-5">
          <span className="font-semibold text-lg sm:text-xl text-gray-800">AUTHORS</span>
          <p className="text-justify text-base sm:text-lg text-gray-700">
            Authors who wish to participate at the conference must register
            individually. The selected paper requires at least one author to
        ...
        <div className="flex flex-col space-y-4 sm:space-y-5">
          ...
          <div className="flex flex-col space-y-2 sm:space-y-5">
            <span className="text-gray-700 text-base sm:text-lg">1. Accepted</span>
            <span className="text-gray-700 text-base sm:text-lg">
              2. May be accepted with Minor/Major changes
            </span>
            <span className="text-gray-700 text-base sm:text-lg">3. Rejected</span>
          </div>
        </div>
        <div className="flex flex-col space-y-4 sm:space-y-5">
          <span className="font-semibold text-lg sm:text-xl text-gray-800">
